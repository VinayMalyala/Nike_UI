    ...
    <section id="home" className='w-full flex flex-col xl:flex-row justify-center min-h-screen gap-10 max-container'>
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
          ...
          <p className="font-montserrat text-slate-gray text-lg leading-8 mb-14 mt-6 sm:max-w-sm">
            Discover stylish Nike arrivials, quality comfort, and innovation for your active life.
          </p>
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        <div className='flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] px-6'>
          {shoes.map((shoe) => (
            <div key={shoe}>
